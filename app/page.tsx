          ...
          <div className="grid-2" style={{ marginBottom: '20px' }}>
            {[
              ...
              <div key={p.name} style={{ background: 'rgba(255,255,255,0.6)', borderRadius: '12px', padding: '28px', textAlign: 'left', position: 'relative' }}>
                <div style={{ position: 'absolute', top: '24px', right: '24px', width: '36px', height: '3px', background: '#D4A833', borderRadius: '2px' }} />
                <Image src={p.photo} alt={p.name} width={48} height={48} style={{ borderRadius: '50%', objectFit: 'cover', objectPosition: 'top', marginBottom: '16px' }} />
