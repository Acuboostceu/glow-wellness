...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: 'system-ui, sans-serif' }}>
      ...
      {/* NAV */}
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 48px', background: '#4A3728', position: 'sticky', top: 0, zIndex: 50, borderBottom: '0.5px solid #5C4535' }}>
      ...
      {/* HERO */}
      <section style={{ background: 'linear-gradient(180deg, #4A3728 0%, #5C4535 70%, #7A6050 100%)', padding: '96px 48px 80px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '20px' }}>
      ...
      {/* ABOUT */}
      <section id="about" style={{ background: 'linear-gradient(180deg, #EDE3D8 0%, #FBF7F2 100%)', padding: '72px 48px 0' }}>
      ...
      {/* MODALITIES */}
      <section id="modalities" style={{ background: 'linear-gradient(180deg, #FBF7F2 0%, #F0E6D8 100%)', padding: '48px 48px 72px' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.85)', border: '0.5px solid #E0D4C4', borderRadius: '12px', padding: '24px', gridColumn: 'span 2', textAlign: 'left' }}>
              <div style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#D4A833', marginBottom: '14px' }} />
